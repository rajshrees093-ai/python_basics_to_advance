...
#number=random.randint(1, 6) #Return random integer in range [a, b], including both end points. 
low=20
high=100
...
number=random.random() #random() method is used for floating point number between 0 and 1
print(number)
...
#     vonmisesvariate(mu, kappa) method of Random instance        Circular data distribution.                    
