#madlib game : it is a word game where you create stories by filling in blanks with random words
...
verb1=input("enter the verb (in present tense ie ending with ing): ") 
